...
//const u_int8_t c64enh[] = sizeof(c64)/sizeof(c64[0]);
//const uint8_t c64enh[] PROGMEM =
//int8_t width = (int8_t)c64enh[0]; // Convert back to signed
const uint8_t c64enh[] PROGMEM = 
{
        249, 8, 32, '~'+1+18,   // -width, height, firstChar, lastChar -7, 8, 32, ('~' + 1 + 18),
